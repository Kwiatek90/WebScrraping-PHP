            ...
            <div class="col-3">
                <div class="form-group">
                    ...
                    <select multiple class="form-control" name="shop[]">
                        ...
                        <option value="media" <?php if(isset($_GET['shop']) && in_array('media', $_GET['shop'])): ?> selected <?php endif; ?>>Morelle</option>
                    </select>
                </div>
            </div>
            <div class="col-3">
            ...
            <div class="col-3">
                <div class="form-group">
                    ...
                    <select class="form-control" name="ram">
                        ...
                        <option <?php if(isset($_GET['ram']) && $_GET['ram'] === '32'): ?> selected <?php endif; ?> value="32">32 GB lub więcej</option>
                    </select>
                </div>
            </div>
        </div>
